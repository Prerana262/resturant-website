    ...
    var menuItems = [
      {
        ...
        description: "Pancakes with Strawberry,Blueberries and Maple Syrup.",
      },
      {
        title: "Dish 2",
      ...
      },
      {
        ...
        description:
          "Grilled Meat with Green Ladies Finger Vegetable.",
      },
      {
        title: "Dish 5",
        image: "assets/dish5.jpg",
        description:
          "Fresh Hummus and Pitta Bread.",
      },
      {
        title: "Dish 6",
        image: "assets/dish6.jpg",
        description: "Vanilla Icecream Sundae.",
      },
      {
        title: "Dish 7",
        image: "assets/dish7.jpg",
        description:
          "Stack of Pancakes with Sauce.",
      },
      {
        title: "Dish 8",
        image: "assets/dish8.jpg",
        description:
          "Noodles Soup with Meat.",
      },
      {
        title: "Dish 9",
      ...
      },
      {
        ...
        description:
          "A Waffle with Sliced Fresh Fruit Toppings.",
      },
      {
        title: "Dish 12",
